class OnGoingModel {
  ...
  String? message;
  var count;
  List<OrderListOnGoing>? orderListOnGoing;

  OnGoingModel({this.success, this.message, this.count, this.orderListOnGoing});

  OnGoingModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    message = json['message'];
    count = json['count'];
    if (json['orderList'] != null) {
      orderListOnGoing = <OrderListOnGoing>[];
      json['orderList'].forEach((v) {
        orderListOnGoing!.add(new OrderListOnGoing.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.orderListOnGoing != null) {
      data['orderList'] = this.orderListOnGoing!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}

class OrderListOnGoing {
  String? sId;
  String? bookingId;
  Pickup? pickup;
  Delivery? delivery;
  ...
  OrderListOnGoing.fromJson(Map<String, dynamic> json) {
    sId = json['_id'];
